...
[https://github.com/RustyMoose/Rust.ServerMetrics](https://github.com/RustyMoose/Rust.ServerMetrics)
...
5. At this point, your setup should be complete. You can log into Grafana with the default username `admin` and password `admin`. Please change this. Please follow the Rust Server Metrics instructions to proceed. You should begin at **Step 6**: [https://github.com/Pinkstink-Rust/Rust-Server-Metrics](https://github.com/RustyMoose/Rust.ServerMetrics)
